...
--nextflow_config /hot/software/pipeline/pipeline-call-SRC/Nextflow/development/unreleased/yashpatel-add-phylowgs/ILHNLNEV000001-N002-A01-F.config \
...
--pipeline_run_name ILHNLNEV000001-N002-A01-F-F16 \
--partition_type F16 \
